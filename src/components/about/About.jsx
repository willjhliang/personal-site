    ...
    return (
        <section className="about" id="about">
            <div className="about-content">
                ...
                <ScrollAnimation animateIn="about-content-description-animation" animateOnce={true} initiallyVisible={true} animatePreScroll={false}>
            ...
            <ScrollAnimation animateIn="about-picture-animation" animateOnce={true} animatePreScroll={false}>
